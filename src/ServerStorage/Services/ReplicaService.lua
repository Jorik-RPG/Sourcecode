...
do
	...
	local MadworkScriptSignal = require(ReplicatedStorage:WaitForChild("Libs"):WaitForChild("ThirdParty").MadworkScriptSignal)
...
local RateLimiter = require(ReplicatedStorage:WaitForChild("Libs"):WaitForChild("ThirdParty").RateLimiter)
local MadworkMaid = require(ReplicatedStorage:WaitForChild("Libs"):WaitForChild("ThirdParty").MadworkMaid)
...
-- Getter:
function Replica:GetValue(path)
	...
	local value = pointer[path_array[#path_array]]
	return value
end
...
function Replica:SetValue(path, value)
	...
	local old_value = pointer[path_array[#path_array]]
